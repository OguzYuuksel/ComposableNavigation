...
//    init<Destination: View, Label: View>(
...
//        _ text: String, destination: @autoclosure @escaping () -> Destination,
//        isActive: Binding<Bool>
//    ) {
...
//    init<Value, Destination: View, Label: View>(
...
//    @available(tvOS, introduced: 13, deprecated: 16)
//    @available(watchOS, introduced: 6, deprecated: 9)
//    public init<Enum, Case, Destination: View, Label: View>(
